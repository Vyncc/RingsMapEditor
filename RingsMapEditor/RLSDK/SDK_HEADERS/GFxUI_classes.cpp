...
// const class FName&             Key                            (CPF_Parm)
...
// Parameter Info:
// const class FName&             EventName                      (CPF_Parm)
// const class FName&             SoundThemeName                 (CPF_OptionalParm | CPF_Parm)
...
// const class FName&             Path                           (CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FName&             WidgetName                     (CPF_Parm)
// const class FName&             WidgetPath                     (CPF_Parm)
...
// const class FString&           method                         (CPF_Parm | CPF_NeedCtorLink)
// const class TArray<struct FASValue>& args                           (CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// class UGFxObject*              ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FString&           ASClass                        (CPF_Parm | CPF_NeedCtorLink)
// class UClass*                  Type                           (CPF_OptionalParm | CPF_Parm)
// const class TArray<struct FASValue>& args                           (CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink)
...
// const class TArray<class FString>& Arg                            (CPF_Parm | CPF_NeedCtorLink)
...
// const class FString&           Path                           (CPF_Parm | CPF_NeedCtorLink)
// int32_t                        Index                          (CPF_Parm)
// const class TArray<float>&     Arg                            (CPF_Parm | CPF_NeedCtorLink)
...
// const class FString&           Path                           (CPF_Parm | CPF_NeedCtorLink)
// int32_t                        Index                          (CPF_Parm)
// const class TArray<int32_t>&   Arg                            (CPF_Parm | CPF_NeedCtorLink)
...
// const class FString&           Path                           (CPF_Parm | CPF_NeedCtorLink)
// int32_t                        Index                          (CPF_Parm)
// const class TArray<struct FASValue>& Arg                            (CPF_Parm | CPF_NeedCtorLink)
...
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// int32_t                        ControllerId                   (CPF_Parm)
// const class FName&             ButtonName                     (CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FString&           Resource                       (CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// class UGFxObject*              ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FString&           symbolname                     (CPF_Parm | CPF_NeedCtorLink)
// const class FString&           instancename                   (CPF_Parm | CPF_NeedCtorLink)
...
// [0x00020401] (FUNC_Final | FUNC_Native | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FString&           frame                          (CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// const class FString&           StringToTranslate              (CPF_Parm | CPF_NeedCtorLink)
// class UTranslationContext*     InContext                      (CPF_OptionalParm | CPF_Parm)
...
// const class FName&             fname                          (CPF_Parm)
...
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// const class FName&             Typename                       (CPF_Parm)
...
// [0x00024003] (FUNC_Final | FUNC_Defined | FUNC_NoExport | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FName&             Type                           (CPF_Parm)
// const struct FScriptDelegate&  Listener                       (CPF_Parm | CPF_NeedCtorLink)
// bool                           useCapture                     (CPF_OptionalParm | CPF_Parm)
// int32_t                        listenerPriority               (CPF_OptionalParm | CPF_Parm)
// bool                           useWeakReference               (CPF_OptionalParm | CPF_Parm)
