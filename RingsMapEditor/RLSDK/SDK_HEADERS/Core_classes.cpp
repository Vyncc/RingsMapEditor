...
bool UObject::Is(class UClass* uClass)
{
...
// const struct FRotator&         From                           (CPF_Parm)
// const struct FRotator&         To                             (CPF_Parm)
...
// const struct FVector&          From                           (CPF_Parm)
// const struct FVector&          To                             (CPF_Parm)
// float                          Lambda                         (CPF_Parm)
// float                          DeltaTime                      (CPF_Parm)
...
// [0x00022401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FString&           EventName                      (CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// int32_t                        ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FString&           TimerName                      (CPF_Parm | CPF_NeedCtorLink)
...
// const class FName&             PropertyName                   (CPF_Parm)
// const class FName&             StructName                     (CPF_Parm)
...
// const struct FLinearColor&     C                              (CPF_Parm)
...
// const struct FColor&           C                              (CPF_Parm)
...
// Parameter Info:
// struct FVector                 ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FVector&          NormalToFlatten                (CPF_Parm)
// const struct FVector&          PlaneNormal                    (CPF_Parm)
...
// const class FString&           Path                           (CPF_Const | CPF_Parm | CPF_NeedCtorLink)
...
// class UObject*                 ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_CoerceParm)
// class UObject*                 ObjOuter                       (CPF_OptionalParm | CPF_Parm)
// const class FName&             ObjName                        (CPF_OptionalParm | CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FVector&          LineStart                      (CPF_Parm)
// const struct FVector&          LineEnd                        (CPF_Parm)
// const struct FVector&          PlaneOrigin                    (CPF_Parm)
// const struct FVector&          PlaneNormal                    (CPF_Parm)
...
// [0x00422401] (FUNC_Final | FUNC_Native | FUNC_Static | FUNC_Public | FUNC_HasOutParms | FUNC_AllFlags)
// Parameter Info:
// const class FString&           PropertyName                   (CPF_Parm | CPF_NeedCtorLink)
...
// const class FName&             ValueName                      (CPF_Parm | CPF_CoerceParm)
...
// Parameter Info:
// const class FName&             ProbeFunc                      (CPF_Parm)
...
// [0x00020800] (FUNC_Event | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FName&             NextStateName                  (CPF_Parm)
...
// [0x00020800] (FUNC_Event | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FName&             PreviousStateName              (CPF_Parm)
...
// [0x00024401] (FUNC_Final | FUNC_Native | FUNC_NoExport | FUNC_OptionalParm | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FName&             NewState                       (CPF_Parm)
// const class FName&             NewLabel                       (CPF_OptionalParm | CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FName&             TestState                      (CPF_Parm)
// const class FName&             TestParentState                (CPF_Parm)
...
// Parameter Info:
// const class FName&             NewState                       (CPF_OptionalParm | CPF_Parm)
// const class FName&             Label                          (CPF_OptionalParm | CPF_Parm)
...
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// const class FString&           SectionName                    (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
// const class FString&           KeyName                        (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
// const class FString&           PackageName                    (CPF_OptionalParm | CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
// Parameter Info:
// const class FString&           S                              (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
// const class FName&             Tag                            (CPF_OptionalParm | CPF_Parm)
...
// Parameter Info:
// struct FLinearColor            ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FLinearColor&     ColorA                         (CPF_Parm)
// const struct FLinearColor&     ColorB                         (CPF_Parm)
...
// Parameter Info:
// struct FLinearColor            ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FLinearColor&     OldColor                       (CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FName&             A                              (CPF_Parm)
// const class FName&             B                              (CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FName&             ClassName                      (CPF_Parm)
...
// Parameter Info:
// class FString                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm | CPF_NeedCtorLink)
// const class FString&           InValue                        (CPF_Parm | CPF_NeedCtorLink)
...
// const class FString&           Prefix                         (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
// const struct FRotator&         Direction                      (CPF_Parm)
...
// Parameter Info:
// struct FRotator                ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FVector&          AxisToRemove                   (CPF_Parm)
// const struct FRotator&         RotToFlatten                   (CPF_Parm)
// const struct FRotator&         RotToFlattenTo                 (CPF_OptionalParm | CPF_Parm)
...
// Parameter Info:
// float                          ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FVector&          V0                             (CPF_Parm)
// const struct FVector&          v1                             (CPF_Parm)
...
// struct FVector                 ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const struct FVector&          A                              (CPF_Parm)
// const struct FVector&          Min                            (CPF_Parm)
// const struct FVector&          Max                            (CPF_Parm)
...
// const struct FVector&          Velocity                       (CPF_Parm)
// float                          Gravity                        (CPF_Parm)
// float                          Time                           (CPF_Parm)
// const struct FVector&          GravityDirection               (CPF_OptionalParm | CPF_Parm)
...
// Parameter Info:
// struct FColor                  ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FString&           Hex                            (CPF_Parm | CPF_NeedCtorLink)
...
// const class FString&           InErrorMessage                 (CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink)
...
// const class FName&             Error                          (CPF_Parm)
...
// Parameter Info:
// const class FString&           Text                           (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
// const struct FColor&           InColor                        (CPF_OptionalParm | CPF_Parm)
...
// [0x00020803] (FUNC_Final | FUNC_Defined | FUNC_Event | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FString&           PropertyName                   (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
// [0x00020803] (FUNC_Final | FUNC_Defined | FUNC_Event | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FString&           Title                          (CPF_Parm | CPF_CoerceParm | CPF_NeedCtorLink)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FName&             Category                       (CPF_Parm)
...
// Parameter Info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class FString&           Key                            (CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// const class FString&           Key                            (CPF_Parm | CPF_NeedCtorLink)
// const class FString&           Value                          (CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// const struct FScriptDelegate&  Callback                       (CPF_Parm | CPF_NeedCtorLink)
// const struct FScriptDelegate&  Callback2                      (CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink)
...
// Parameter Info:
// class UClass*                  BaseClass                      (CPF_Parm)
// const struct FScriptDelegate&  OnAdd                          (CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink)
// const struct FScriptDelegate&  OnRemove                       (CPF_OptionalParm | CPF_Parm | CPF_NeedCtorLink)
...
// [0x00020401] (FUNC_Final | FUNC_Native | FUNC_Public | FUNC_AllFlags)
// Parameter Info:
// const class FString&           Category                       (CPF_Parm | CPF_NeedCtorLink)
// float                          Value                          (CPF_Parm)
...
// Parameter Info:
// class UAsyncTask*              ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)
// const class TArray<class UAsyncTask*>& Dependents                     (CPF_Parm | CPF_NeedCtorLink)
...
// const struct FRotator&         InRotator                      (CPF_Const | CPF_Parm)
