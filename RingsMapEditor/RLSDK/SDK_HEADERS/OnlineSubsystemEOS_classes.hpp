...
public:
	...
	bool GetLocalAccountNames(class TArray<class FString>& Accounts);
	...
	bool RegisterStatGuid(const struct FUniqueNetId& PlayerID, class FString& ClientStatGuid);
	...
	bool WriteOnlinePlayerScores(class TArray<struct FOnlinePlayerScore>& PlayerScores);
	...
	bool GetRecognitionResults(uint8_t LocalUserNum, class TArray<struct FSpeechRecognizedWord>& Words);
...
public:
	...
	void GetBlockList(uint8_t LocalUserNum, class TArray<struct FOnlineFriend>& OutBlockList);
	...
	bool RecordPlayersRecentlyMet(uint8_t LocalUserNum, const class FString& GameDescription, class TArray<struct FUniqueNetId>& Players);
	...
	EOnlineEnumerationReadState GetAchievements(uint8_t LocalUserNum, int32_t optionalTitleId, class TArray<struct FAchievementDetails>& Achievements);
	...
	bool ShowCustomPlayersUI(uint8_t LocalUserNum, const class FString& Title, const class FString& Description, class TArray<struct FUniqueNetId>& Players);
	...
	bool CanCommunicateVoice(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanCommunicateVideo(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanCommunicateText(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanShareUserCreatedContent(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanAccessPremiumVideoContent(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanAccessPremiumContent(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanUseCloudStorage(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanRecordDVRClips(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanBrowseInternet(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanShareWithSocialNetwork(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanShareKinectContent(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanUploadFitnessData(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	...
	bool GetPlayHistoryRegistrationKey(class TArray<uint8_t>& Key);
	...
	bool RecordPlayersRecentlyMetKeys(uint8_t LocalUserNum, class TArray<struct FFriendHistoryKey>& PlayerKeys);
	...
	bool ShowCustomMessageUI(uint8_t LocalUserNum, const class FString& MessageTitle, const class FString& NonEditableMessage, const class FString& optionalEditableMessage, class TArray<struct FUniqueNetId>& Recipients);
	...
	void GetFriendMessages(uint8_t LocalUserNum, class TArray<struct FOnlineFriendMessage>& FriendMessages);
	...
	void SetOnlineStatus(uint8_t LocalUserNum, int32_t StatusId, class TArray<struct FLocalizedStringSetting>& LocalizedStringSettings, class TArray<struct FSettingsProperty>& Properties);
	EOnlineEnumerationReadState GetFriendsList(uint8_t LocalUserNum, int32_t optionalCount, int32_t optionalStartingAt, class TArray<struct FOnlineFriend>& Friends);
	...
	bool AreAnyFriends(uint8_t LocalUserNum, class TArray<struct FFriendsQuery>& Query);
	bool IsFriend(uint8_t LocalUserNum, const struct FUniqueNetId& PlayerID);
	bool CanShowPresenceInformation(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanViewPlayerProfiles(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanPurchaseContent(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	bool CanDownloadUserContent(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
	...
	bool CanPlayOnline(uint8_t LocalUserNum, bool optionalBAttemptToResolve, const class FString& optionalReason, EFeaturePrivilegeLevel& PrivilegeLevelHint);
...
public:
	...
	bool RegisterHostStatGuid(class FString& HostStatGuid);
	class FString GetHostStatGuid();
	bool WriteOnlinePlayerScores(const class FName& SessionName, int32_t LeaderboardId, class TArray<struct FOnlinePlayerScore>& PlayerScores);
	...
	bool ReadOnlineStatsForFriends(uint8_t LocalUserNum, class UOnlineStatsRead* StatsRead);
	bool ReadOnlineStats(uint8_t LocalUserNum, class UOnlineStatsRead* StatsRead, class TArray<struct FUniqueNetId>& Players);
};
...
public:
	...
	class TArray<struct FVoiceAudioDevice>             InputAudioDevices;                             // 0x0088 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FVoiceAudioDevice>             OutputAudioDevices;                            // 0x0098 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	struct FMap_Mirror                                 AccountsAcceptedVoiceModerationEULAMap;        // 0x00A8 (0x0050) [0x0000004000001000] (CPF_Native)  
	class TArray<class FString>                        AccountsWithAgreementResponse;                 // 0x00F8 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	void __OnlinePlayerInterfaceEOS__LinkedAccount_0x1(int32_t _, const class FString& PlatformAuthTicket);
};
