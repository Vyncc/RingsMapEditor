...
public:
	...
	bool LinePlaneIntersection(const struct FVector& LineStart, const struct FVector& LineEnd, const struct FVector& PlaneOrigin, const struct FVector& PlaneNormal, bool optionalBCheckLineSegment, struct FVector& Out_Intersection, float& Out_T);
	...
	static float PointDistToLine(const struct FVector& Point, const struct FVector& Line, const struct FVector& Origin, struct FVector& OutClosestPoint);
	...
	static void ImportJSON(const class FString& PropertyName, class FString& JSON);
	...
	static class FString JoinArrayQWord(const class FString& optionalDelim, bool optionalBIgnoreBlanks, class TArray<uint64_t>& QWordArray);
	static class FString JoinArrayInt(const class FString& optionalDelim, bool optionalBIgnoreBlanks, class TArray<int32_t>& IntArray);
	static class FString JoinArrayName(const class FString& optionalDelim, bool optionalBIgnoreBlanks, class TArray<class FName>& NameArray);
	static class FString JoinArrayStr(const class FString& optionalDelim, bool optionalBIgnoreBlanks, class TArray<class FString>& StringArray);
	static void JoinArray(const class FString& optionalDelim, bool optionalBIgnoreBlanks, class TArray<class FString>& StringArray, class FString& out_Result);
...
public:
	...
	void SetTimer(class UObject* Event, float Delay, const struct FTimerOptions& optionalOptions);
	void Broadcast(class UObject* Event);
	void CreateObjects(class UObject* optionalObjOuter, class TArray<class UClass*>& ObjectClasses);
...
public:
	...
	static void DecodeInline(class TArray<uint8_t>& Input, class FString& Output);
	static class FString Decode(class TArray<uint8_t>& Input);
	static void EncodeInline(const class FString& Input, class TArray<uint8_t>& Output);
...
public:
	...
	static void TriggerAll(class TArray<class USubscription*>& Subscriptions);
...
public:
	...
	static bool SaveBytesToFile(const class FString& Path, class TArray<uint8_t>& Bytes);
	static bool LoadFileToBytes(const class FString& Path, int32_t optionalStartOffset, int32_t optionalLength, class TArray<uint8_t>& OutBytes);
	static bool LoadFileToString(const class FString& Path, class FString& OutText);
	...
	static void FindFiles(const class FString& Path, class TArray<class FString>& OutFilenames);
};
...
public:
	...
	static bool ZLibCompress(class TArray<uint8_t>& Uncompressed, class TArray<uint8_t>& OutCompressed);
};
...
public:
	...
	bool TryGetObjectW(const class FString& Key, class UObject*& OutValue);
	void TryGet();
...
public:
	...
	bool Contains(const class FString& Key);
	void Remove(const class FString& Key);
	bool TryGet(const class FString& Key, class FString& OutValue);
...
public:
	...
	class TArray<class UObject*>                       MyObjects;                                     // 0x0078 (0x0010) [0x0000004000402002] (CPF_Const | CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void AddAndRemoveObjects(class TArray<class UObject*>& AddObjects, class TArray<class UObject*>& RemoveObjects);
	void RemoveObjects(class TArray<class UObject*>& InObjects);
	void RemoveAllObjects(class UClass* ObjectClass);
	void RemoveObject(class UObject* Obj);
	void AddObjects(class TArray<class UObject*>& InObjects);
...
public:
	...
	static void DecodeStringInline(const class FString& Input, class TArray<uint8_t>& Output);
	static class TArray<uint8_t> DecodeString(const class FString& Input);
	static void DecodeInline(class TArray<uint8_t>& Input, class TArray<uint8_t>& Output);
	static class TArray<uint8_t> Decode(class TArray<uint8_t>& Input);
	static void EncodeStringInline(class TArray<uint8_t>& Input, class FString& Output);
	static class FString EncodeString(class TArray<uint8_t>& Input);
	static void EncodeInline(class TArray<uint8_t>& Input, class TArray<uint8_t>& Output);
	static class TArray<uint8_t> Encode(class TArray<uint8_t>& Input);
};
