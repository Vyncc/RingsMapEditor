...
public:
	...
	static void JoinCredentialsFromString(const class FString& Credentials, class FString& JoinName, class FString& JoinPassword);
...
public:
	...
	void eventProcessHit(class AActor* Victim, const struct FVector& HitLocation, float optionalDamageScale, struct FContactInformation& ContactInfo);
};
...
public:
	...
	class TArray<struct FShakeReceiver>                Receivers;                                     // 0x01A8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	bool GetColorParameter(const class FName& InName, struct FColor& OutColor);
	...
	void SetVectorRandParameter(const class FName& ParameterName, struct FVector& Param, struct FVector& ParamLow);
...
public:
	...
	class TArray<class UFXActorEvent_X*>               FXStates;                                      // 0x02A8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<struct FFXActorEventCheck>            FXEvents;                                      // 0x02B8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	...
	class TArray<struct FFXEventSubscription>          EventSubscriptions;                            // 0x02E0 (0x0010) [0x0000004000402002] (CPF_Const | CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	bool Uncompress(class TArray<uint8_t>& Compressed, class TArray<uint8_t>& Uncompressed);
	bool Compress(class TArray<uint8_t>& Uncompressed, class TArray<uint8_t>& Compressed);
};
...
{
public:
	class TArray<struct FPlayerBinding>                PCBindings;                                    // 0x0060 (0x0010) [0x0000004000404000] (CPF_Config | CPF_NeedCtorLink)
	class TArray<struct FPlayerBinding>                GamepadBindings;                               // 0x0070 (0x0010) [0x0000004000404000] (CPF_Config | CPF_NeedCtorLink)
	...
	class TArray<struct FPlayerBinding>                SteamInputBindings;                            // 0x0088 (0x0010) [0x0000004000404000] (CPF_Config | CPF_NeedCtorLink)
...
public:
	...
	static int32_t CrcBytes(class TArray<uint8_t>& Bytes);
...
public:
	...
	void AddDynamicallyLoadedPackages(class TArray<struct FDynamicallyLoadedPackage>& OutPackages);
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	void eventPreExit();
	...
	static bool ConfigGetString(const class FString& SectionName, const class FString& KeyName, class FString& OutValue);
	static bool ParseCommandlineStringArr(const class FString& Param, class TArray<class FString>& OutValues);
	static bool ParseCommandlineString(const class FString& Param, bool optionalBShouldStopOnComma, class FString& OutValue);
	static bool ParseCommandlineQWORD(const class FString& Param, uint64_t& OutValue);
	static bool ParseCommandlineFloat(const class FString& Param, float& OutValue);
	static bool ParseCommandlineInt(const class FString& Param, int32_t& OutValue);
...
public:
	...
	static class FString UniqueNetIDArrayToString(class TArray<struct FUniqueNetId>& Ids);
	...
	static int32_t FindUniqueNetID(class TArray<struct FUniqueNetId>& List, struct FUniqueNetId& Search);
...
public:
	...
	void GetPlayersLikesDislikes(class UGameSettingPlaylist_X* Playlist, class TArray<class FName>& PlayerLikes, class TArray<class FName>& PlayerDislikes);
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	...
	class TArray<bool> GetSyncedAchievements(uint8_t LocalUserNum);
...
public:
	...
	bool Send();
	void RecordEvent(const class FString& Category, const class FName& Event, const struct FUniqueNetId& optionalPlayerID, int32_t optionalVersion, class FString& Data);
...
public:
	...
	void UnstableConnections(class TArray<class FString>& Addresses);
...
public:
	...
	class TArray<struct FPauserData>                   PCPausers;                                     // 0x04A0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void eventPreLoginSplitscreen(const struct FUniqueNetId& PrimaryPlayerUniqueId, const class FString& Options, const class FString& Address, const struct FUniqueNetId& UniqueId, bool bSupportsAuth, class FString& ErrorMessage);
	void eventPreLogin(const class FString& Options, const class FString& Address, const struct FUniqueNetId& UniqueId, bool bSupportsAuth, class FString& ErrorMessage);
...
public:
	...
	void AddGameSettingToList(class UOnlineGameSettings_X* OnlineGameSettings, class TArray<class UGameSetting_X*>& GameSettingsArray);
};
...
{
public:
	class TArray<class FName>                          SelectedNames;                                 // 0x0060 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
	...
	class TArray<class UGameSetting_X*>                GameSettings;                                  // 0x0098 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	...
	void GetSelectedGameSettings(class TArray<class UGameSetting_X*>& SelectedGameSettings);
...
public:
	...
	bool GetAvailableRefreshRates(class TArray<int32_t>& RefreshRates);
	bool GetAvailableResolutions(class TArray<struct FIntPoint>& Resolutions);
	bool GetAvailableResolutionsStr(class TArray<class FString>& Resolutions);
...
public:
	...
	void SetASValue(const class FName& Table, int32_t Row, const class FName& Column, struct FASValue& Value);
...
public:
	...
	class TArray<class UGFxShell_X*>                   Shells;                                        // 0x0130 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<struct FDirtyObject>                  DirtyObjects;                                  // 0x0140 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	static void GetFlashKey(const class FName& UnrealKey, int32_t& KeyCode, int32_t& MouseButton);
...
public:
	...
	class TArray<class FString>                        CursorScenes;                                  // 0x0298 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<class FString>                        InputScenes;                                   // 0x02A8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<class FString>                        CaptureScenes;                                 // 0x02B8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	void SetAllowAnyPlayerInput(bool bAllow);
	bool PopString(const class FString& Value, class TArray<class FString>& Items);
...
public:
	...
	class TArray<struct FSoundPackSoundRef>            Sounds;                                        // 0x0070 (0x0010) [0x0000004000400003] (CPF_Edit | CPF_Const | CPF_NeedCtorLink)
...
public:
	...
	bool BroadcastData(class TArray<uint8_t>& Data);
	void Stop();
...
{
public:
	class TArray<struct FContentPair>                  ContentMap;                                    // 0x0078 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	class TArray<EOnlinePlatform> GetDisabledCrossplayGroup(EOnlinePlatform PlayerPlatform);
...
public:
	...
	void ValueArray(class TArray<struct FOnlineFriend>& OutArray);
	void AppendArray(class TArray<struct FOnlineFriend>& InArray);
	void CopyArray(class TArray<struct FOnlineFriend>& InArray);
	bool Contains(struct FUniqueNetId& Key);
	void Clear(int32_t optionalExpectedElements);
	void Remove(struct FUniqueNetId& Key);
...
public:
	...
	void GetActiveGameSettings(class TArray<class UGameSetting_X*>& GameSettings);
	class UGameSetting_X* GetGameSetting(const class FString& SettingName, class UGameSettingCategory_X*& Category);
...
public:
	...
	class UObject* DeserializeMessage(class UClass* ExpectedMessageBaseClass, class UObject* MessageOuter, class TArray<uint8_t>& Data);
	bool SerializeMessage(class UObject* Message, class TArray<uint8_t>& OutData);
...
public:
	...
	class TArray<struct FNameParamPair>                NameParams;                                    // 0x0078 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<struct FFloatParamPair>               FloatParams;                                   // 0x0088 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<struct FVectorParamPair>              VectorParams;                                  // 0x0098 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<struct FColorParamPair>               ColorParams;                                   // 0x00A8 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<struct FActorParamPair>               ActorParams;                                   // 0x00B8 (0x0010) [0x0000004000400001] (CPF_Edit | CPF_NeedCtorLink)
	class TArray<class UISetParameter*>                AllComponents;                                 // 0x00C8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	static class FName GetKeyForActionArray(const class FName& Action, class TArray<struct FPlayerBinding>& PlayerBindings);
	void AbsorbCurrentKeyPress();
	void SetBindings(class TArray<struct FPlayerBinding>& PC, class TArray<struct FPlayerBinding>& Gamepad);
	...
	static void SetCachedUIKey(const class FString& KeyValue, class FName& KeyName);
	static bool GetCachedUIKey(class FName& KeyName, class FString& OutKey);
...
public:
	...
	class TArray<uint8_t>                              Body;                                          // 0x0068 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	void SetBody(class TArray<uint8_t>& Value);
};
...
public:
	...
	bool LoadFromUTF8(class TArray<uint8_t>& SignedData);
	bool LoadFromSignedUTF8WithSignature(const class FString& Signature, class TArray<uint8_t>& SignedData);
	bool LoadFromSignedUTF8(class TArray<uint8_t>& SignedData);
...
public:
	...
	void GetPermissions(const struct FScriptDelegate& optionalOnAllowed, const struct FScriptDelegate& optionalOnDisallowed, class TArray<struct FUniqueNetId>& PlayerIds);
...
public:
	...
	void eventCreateBatch(class UPsyNetMessage_X* Message, class TArray<struct FPendingRPC>& BatchRPCs);
...
public:
	...
	void DeserializeObject(class UObject* Target, class TArray<uint8_t>& InData);
	void SerializeObject(class UObject* Target, class TArray<uint8_t>& OutData);
};
...
public:
	...
	class TArray<class UOnline_X*>                     OnlineComponents;                              // 0x0158 (0x0010) [0x0000008000400000] (CPF_NeedCtorLink)
...
public:
	...
	class TArray<class UOnlinePlayer_X*>               OnlinePlayers;                                 // 0x01F8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void GetPlayerAvatars(const struct FScriptDelegate& optionalReadOnlineAvatarCompleteDelegate, EAvatarSize optionalSize, class TArray<struct FUniqueNetId>& PlayerIds);
...
public:
	...
	bool AllowSplitscreenJoin(const struct FUniqueNetId& PrimaryPlayerId, const struct FUniqueNetId& PlayerID, const class FString& PlayerName, class FString& Error);
	void PlayerLoggedOut(class APlayerReplicationInfo* PRI);
	void PlayerLoggedIn(class APlayerReplicationInfo* PRI);
	void AllowPlayerLogin(const class FString& Options, const struct FUniqueNetId& PlayerID, class FString& ErrorMessage);
	void OnNewGameInfoCreated(class AGameInfo_X* Game);
...
public:
	...
	class TArray<struct FSteamWebRequestData>          SteamWebRequests;                              // 0x00C8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	bool DoesPlayerOwnDLC(struct FUniqueNetId& PlayerID, class FName& DLCName);
...
public:
	...
	bool IsSkillLeaderboard(const class FString& NewLeaderboardID, int32_t& Playlist);
	...
	bool GetCachedLeaderboardData(const class FName& LeaderboardId, class TArray<struct FLeaderboardData>& LeaderboardDataList);
	int32_t CalcDivision(float TopValue, float Value);
	void GetRankForPrimaryPlayer(const class FName& LeaderboardId, int32_t Value, int32_t& Rank, int32_t& Division);
	...
	void EventNewLeaderboard(const class FName& NewLeaderboardID, class TArray<struct FLeaderboardData>& NewLeaderboardData);
	void OnGetLeaderboardPlayerValue(class UOnlineGameLeaderboards_X* LeaderboardsRef, const class FName& LeaderboardId, class UError* optionalError, struct FLeaderboardData& PlayerLeaderboardData);
};
...
public:
	...
	class TArray<class FString>                        BotNames;                                      // 0x00F8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void GetAccumulatedPrefs(class TArray<class FName>& Likes, class TArray<class FName>& Dislikes);
	void PrintDebugInfo(class UDebugDrawer* Drawer);
	...
	class FString GetPlatformsString(class TArray<EOnlinePlatform>& Platforms);
	class TArray<EOnlinePlatform> GetPlayerPlatforms();
	...
	void PlayerLoggedIn(class APlayerReplicationInfo* PRI);
	void AllowPlayerLogin(const class FString& Options, const struct FUniqueNetId& PlayerID, class FString& ErrorMessage);
	bool AllPlayersInGame(class TArray<struct FUniqueNetId>& OutPlayersInGame);
	bool AllPlayersReserved();
	bool HasGameEnded();
	bool HasGameStarted();
	bool CanStartMatch();
	bool HasMultipleReservedTeams();
	bool HasTimeoutPlayers(class TArray<struct FUniqueNetId>& OutTimeoutPlayers);
	bool HasJoiningPlayers();
	bool CanGoInactive();
	bool IsEmpty();
	bool IsNearlyFull();
	bool IsFull(class TArray<struct FUniqueNetId>& OutPlayersReserved);
	...
	void Reset();
	static void RecordTeamHistory(class TArray<struct FReservationData>& TestPlayers, class TArray<struct FTeamPairHistory>& History);
	void ScrambleTeams();
	void UpdateTeams();
	void AssignTeamsByPartySize();
	static bool AssignScrambledTeams(int32_t TeamSize, class TArray<struct FTeamPairHistory>& History, class TArray<struct FReservationData>& TestPlayers);
	static bool AssignTeams(int32_t TeamSize, bool optionalBKeepTeams, class TArray<struct FReservationData>& TestPlayers);
	...
	void SetPlayers(class TArray<struct FReservationData>& TempPlayers);
	...
	bool IsUnique(class TArray<class FName>& Prefs);
	...
	bool CheckRankedMatchReservation(const struct FUniqueNetId& PlayerID, class FString& InReservationID);
...
public:
	...
	void UploadStats(const class FString& StatType, class TArray<struct FUploadStatDataSet>& DataSet);
...
public:
	...
	static void GetNetworkInfo(class TArray<class FString>& Types);
...
public:
	...
	void SetContent(class TArray<uint8_t>& ContentBytes);
...
public:
	...
	static void SortRequestTimeAscending(class TArray<struct FWordFilterPair>& Filtered);
	static void SortPendingFront(class TArray<struct FWordFilterPair>& Filtered);
...
public:
	...
	class TArray<struct FUniqueNetId> GetPlayerIDs();
	void GetPlayerMapPrefs(const struct FUniqueNetId& PlayerID, class TArray<class FName>& Likes, class TArray<class FName>& Dislikes);
...
{
public:
	class TArray<int32_t>                              ControllerIDs;                                 // 0x0060 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void __OnlinePlayerStorageQueue_X__Construct_0x1(const class FString& _);
	...
	void PartitionStorageRequests(class TArray<struct FPendingStorage>& OutQueue, class TArray<struct FSetPlayerStorageRequestItem>& OutOfDate);
	void SendBatch_Internal(class TArray<struct FPendingStorage>& OutQueue);
	void SendBatch();
	void QueueBatch();
	...
	void EventOutOfSync(class TArray<struct FPendingStorage>& FailedObjects);
...
public:
	...
	static class UPendingAvatarRequest_X* FindRequestFromArray(const struct FUniqueNetId& PlayerID, EAvatarSize Size, class TArray<class UPendingAvatarRequest_X*>& Requests);
	static bool RemoveRequestFromArray(const struct FUniqueNetId& PlayerID, EAvatarSize Size, class TArray<class UPendingAvatarRequest_X*>& Requests);
...
public:
	...
	void __AvatarRequester_X__GetPlayerAvatar_0x2(const struct FUniqueNetId& _);
	void __AvatarRequester_X__GetPlayerAvatar_0x1(const struct FUniqueNetId& _);
};
...
public:
	...
	void TriggerPlayerCallback(const class FString& EpicId, const struct FScriptDelegate& Callback, class TArray<struct FOnlineFriend>& BlockedPlayersArray);
...
public:
	...
	static bool IsClubTeam(int32_t TeamSize, class TArray<uint64_t>& TeamClubs);
	static bool IsClubMatch(int32_t TeamSize, class TArray<uint64_t>& Team0Clubs, class TArray<uint64_t>& Team1Clubs);
};
...
public:
	...
	void SetBadges(class TArray<struct FStatBadge>& InBadges);
...
public:
	...
	void ClearAllExcept(class TArray<uint64_t>& KeepClubs);
	void Clear();
	void Destroy(uint64_t ClubID);
	class UClubDetails_X* UpdateClubBadges(const struct FUniqueNetId& PlayerID, class TArray<struct FStatBadge>& InBadges);
...
{
public:
	class TArray<int32_t>                              PreferredPlaylists;                            // 0x0130 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<struct FDSRegionInfo>                 PreferredRegions;                              // 0x0140 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	class TArray<class URegionPing_X*>                 RegionPings;                                   // 0x00C0 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<struct FCachedRegionPing>             CachedRegionPings;                             // 0x00D0 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void SetCachedRegionPings(class TArray<struct FCachedRegionPing>& InCachedRegionPings);
	void PrintDebugInfo(class UDebugDrawer* Drawer);
...
{
public:
	class TArray<struct FPartyMember>                  PartyMembers;                                  // 0x00B0 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	bool TryGetValueInt(const class FString& Key, class TArray<struct FLobbyMetaData>& MetaData, int32_t& Value);
	...
	void HandleLobbyReceiveBinaryData(int32_t MemberIndex, struct FActiveLobbyInfo& LobbyInfo, class TArray<uint8_t>& Data);
	...
	void HandleJoinLobby(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID);
	...
	void HandleLobbyMemberStatusUpdate(int32_t MemberIndex, int32_t InstigatorIndex, const class FString& Status, struct FActiveLobbyInfo& LobbyInfo);
	...
	void OnPartyCreated(bool bWasSuccessful, const class FString& Error, struct FUniqueLobbyId& InPartyId);
...
public:
	...
	class UPartyMessage_SearchStatus_X* SetPreferredPlaylists(class TArray<int32_t>& InPlaylists);
...
public:
	...
	class TArray<class UPlayer*>                       JoinedPlayers;                                 // 0x02D8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	bool IsJoiningGame();
	void CancelJoin();
	bool StartJoinCustomMatch(const struct FServerReservationData& Reservation, const struct FJoinMatchSettings& optionalJoinSettings, struct FCustomMatchSettings& InSettings);
	bool StartJoinPrivateMatch(const struct FServerReservationData& Reservation, const struct FJoinMatchSettings& optionalJoinSettings, struct FCustomMatchSettings& InSettings);
...
public:
	...
	void HandleJoinPlatformLobby(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID);
...
public:
	...
	struct FUniqueNetId FindPartyLeaderID(class TArray<struct FPsyNetPartyMember>& Members);
	...
	bool SetLobbyServer(const class FString& ServerIP, struct FUniqueLobbyId& LobbyId, struct FUniqueNetId& ServerUID);
	bool RemoveLobbySetting(const class FString& Key, struct FUniqueLobbyId& LobbyId);
	bool SetLobbySetting(const class FString& Key, const class FString& Value, struct FUniqueLobbyId& LobbyId);
	bool GetLobbyAdmin(struct FUniqueLobbyId& LobbyId, struct FUniqueNetId& AdminId);
	bool SendLobbyBinaryData(struct FUniqueLobbyId& LobbyId, class TArray<uint8_t>& Data);
	void HandleLobbyMessageFailed(class URPC_PartyChat_X* RPC);
	bool SendLobbyMessage(const class FString& Message, struct FUniqueLobbyId& LobbyId);
	bool SetLobbyUserSetting(const class FString& Key, const class FString& Value, struct FUniqueLobbyId& LobbyId);
	...
	void HandlePsyNetPartyJoined(const struct FUniqueLobbyId& PsyNetPartyId, class TArray<struct FPsyNetPartyMember>& Members);
	void HandlePsyNetPartyCreated(const struct FUniqueLobbyId& PsyNetPartyId, class TArray<struct FPsyNetPartyMember>& Members);
	...
	bool GetLobbyMembers(struct FUniqueLobbyId& LobbyId, class TArray<struct FLobbyMember>& Members);
	...
	void OnLobbyJoinGame(const class FString& ServerIP, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueNetId& ServerId);
	...
	void OnLobbyReceiveBinaryData(int32_t MemberIndex, struct FActiveLobbyInfo& LobbyInfo, class TArray<uint8_t>& Data);
	...
	void OnLobbyReceiveMessage(int32_t MemberIndex, const class FString& Type, const class FString& Message, struct FActiveLobbyInfo& LobbyInfo);
	...
	void OnLobbyMemberStatusUpdate(int32_t MemberIndex, int32_t InstigatorIndex, const class FString& Status, struct FActiveLobbyInfo& LobbyInfo);
	...
	void OnJoinLobbyComplete(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyId);
	...
	void OnFindLobbiesComplete(bool bWasSuccessful, class TArray<struct FBasicLobbyInfo>& LobbyList);
	...
	void OnCreateLobbyComplete(bool bWasSuccessful, const class FString& Error, struct FUniqueLobbyId& LobbyId);
	void OnExit();
	void Init();
	void eventConstruct();
...
public:
	...
	void HandleJoinPsyNetLobby(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID);
...
{
public:
	class TArray<class UPrivilegeCheck_X*>             PendingChecks;                                 // 0x00B0 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	class TArray<class UGameSettingPlaylist_X*>        DownloadedPlaylists;                           // 0x00B8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	class TArray<class FName> GetAccessiblePlaylists(class TArray<class FName>& SelectedPlaylists);
	...
	void NamesToIDs(class TArray<class FName>& Names, class TArray<int32_t>& Ids);
...
public:
	...
	class TArray<class UPresetMutators_X*>             PresetMutators;                                // 0x0120 (0x0010) [0x0000008000400001] (CPF_Edit | CPF_NeedCtorLink)
...
{
public:
	class TArray<class UPlaylistSkillCache_X*>         Playlists;                                     // 0x00B0 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<struct FPlayerSeasonRewardProgress>   SeasonRewards;                                 // 0x00C0 (0x0010) [0x0000008000402000] (CPF_Transient | CPF_NeedCtorLink)
...
{
public:
	class TArray<struct FUpdatedPlayerSkillRating>     Players;                                       // 0x0060 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void HandleCommentSanitized(const class FString& Id, struct FWordFilterResult& Result);
...
public:
	...
	class TArray<struct FOnlineFriend>                 EpicInvites;                                   // 0x00D0 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	void TriggerSocialCallback(const struct FUniqueNetId& InPlayerID, class UError* Error, class TArray<struct FEpicSocialTaskData>& TaskList);
	...
	void SetEpicFriendData(class UOnlineFriendMap_X* OutFriends, class TArray<struct FOnlineFriend>& AllFriends, class TArray<struct FOnlineFriend>& OutInvites);
...
public:
	...
	class UAsyncTask* SyncObjects(class TArray<struct FOnlinePlayerStorageSyncRequest>& Requests);
...
public:
	...
	void HandlePlatformPartyCreated(bool bWasSuccessful, const class FString& Error, struct FUniqueLobbyId& PlatformPartyID);
	...
	void EventPartyCreated(const struct FUniqueLobbyId& PsyNetPartyId, class TArray<struct FPsyNetPartyMember>& Members);
};
...
public:
	...
	void Init();
	void EventJoinedParty(const struct FUniqueLobbyId& PsyNetPartyId, class TArray<struct FPsyNetPartyMember>& Members);
};
...
public:
	...
	void __PRI_X__RegisterPlayerWithSession_0x1(const struct FUniqueNetId& _);
};
...
public:
	...
	class TArray<class UPsyNetChannel_X*>              Channels;                                      // 0x0070 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
{
public:
	class TArray<class USuperRegion_X*>                SuperRegions;                                  // 0x0078 (0x0010) [0x0000008000400000] (CPF_NeedCtorLink)
...
public:
	...
	void UnRegisterTriggers(class TArray<class UStatusTrigger_X*>& InTriggers);
	void RegisterTriggers(class TArray<class UStatusTrigger_X*>& InTriggers);
...
{
public:
	class TArray<class UClubInvite_X*>                 Result;                                        // 0x00D0 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventResult__Delegate;                       // 0x00E0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
{
public:
	class TArray<class ULanServerRecord_X*>            Result;                                        // 0x00D0 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventResult__Delegate;                       // 0x00E0 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __EventResultComplete__Delegate;               // 0x00F8 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
	struct FScriptDelegate                             __ResultDelegate__Delegate;                    // 0x0110 (0x0018) [0x0000000000400000] (CPF_NeedCtorLink)
...
public:
	...
	void __WebImageCache_X__HandleImageData_0x1(const class FString& _, const struct FImageLayout& Image);
};
...
public:
	...
	static void BlendPOVs(const struct FCameraOrientation& FromPOV, const struct FCameraOrientation& ToPOV, float Percent, struct FCameraOrientation& OutPOV);
	...
	static void CalculateDistanceRotation(const struct FVector& Focus, const struct FVector& Origin, float& OutDistance, struct FRotator& OutRotation);
};
...
public:
	...
	void HandleClientReservationMessage(class UIReservationConnection_X* Connection, class UClientReservationMessage_X* Message);
	void SendRequest();
	void HandlePreLoadMap(const class FString& _);
	void Cancel();
	bool IsSearching();
...
public:
	...
	void RecordFoundServer(bool bFromNotification, const struct FGuid& optionalMatchMakingGuid, bool optionalBDisableCrossPlay, float optionalMMR, int32_t optionalTier, struct FServerReservationData& Reservation);
...
public:
	...
	struct FPingStats CalcPingStats(class TArray<float>& Pings);
	void Record();
	void RecordTimer();
	void StopRecording();
	void StartRecording();
...
public:
	...
	void HandleLost(class UUdpPingBeaconClient_X* _, const class FName& __);
	void HandlePong(class UUdpPingBeaconClient_X* _, const class FName& __, float DeltaSeconds);
	void SendPing();
	void StopPinging();
	void StartPinging();
...
public:
	...
	class TArray<uint8_t>                              Stream;                                        // 0x0078 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	class TArray<class UDynamicValueModifier_X*>       Modifiers;                                     // 0x0070 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	void __OnlineGameDedicatedServerRegistration_X__OnInit_0x1(const class FString& _);
...
public:
	...
	class FName                                        MapName;                                       // 0x0090 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
...
public:
	...
	static void AddModes(class TArray<class UClass*>& NetModes);
...
public:
	...
	void OnGameInviteAccepted(const class FString& ErrorString, struct FOnlineGameSearchResult& InviteResult);
	void OnInit();
...
public:
	...
	class TArray<struct FGetPopulationData>            Populations;                                   // 0x00C8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	void HandleTaskSuccess(const struct FServerReservationData& Reservation);
	class FString GetRegionsString();
	void OnSearchComplete(class TArray<struct FServerResult>& Results);
	...
	void EventSearchComplete(class TArray<struct FServerResult>& Results);
};
...
public:
	...
	bool FindPlayerReportIndex(const struct FUniqueNetId& PlayerID, int32_t& OutIndex);
...
public:
	...
	class TArray<class FString>                        PlayersPlatforms;                              // 0x0128 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FUniqueNetId>                  PlayerIds;                                     // 0x0138 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FUniqueNetId>                  AbandonedPlayerIDs;                            // 0x0148 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	class TArray<struct FGetLeaderboardPlatformBaseData> Platforms;                                     // 0x0100 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
{
public:
	class TArray<struct FUniqueNetId>                  PlayerIds;                                     // 0x00E8 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class FString                                      LeaderboardId;                                 // 0x00F8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
	class TArray<struct FGetLeaderboardRankForUserData> Players;                                       // 0x0108 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
{
public:
	class TArray<struct FGetPopulationData>            Playlists;                                     // 0x00E8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	class TArray<struct FSuperRegionData>              Regions;                                       // 0x00F8 (0x0010) [0x0001004000400000] (CPF_NeedCtorLink)
...
public:
	...
	class URPC_GetSubRegions_X* SetRegionSecrets(class TArray<struct FRegionSecret>& InRegions);
};
...
{
public:
	class TArray<struct FRegionSecret>                 Regions;                                       // 0x00E8 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FGetGameServerPingListData_Deprecated> Servers;                                       // 0x00F8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	class URPC_GetGameServerPingList_X* SetRegionSecrets(class TArray<struct FRegionSecret>& InRegions);
	void eventOnSuccess();
};
...
public:
	...
	void HandlePong(class UUdpPingBeaconClient_X* _, const class FName& Address, float DeltaSeconds);
	void SendPing(int32_t Idx);
	void Tick(float _);
	void StopPingBeacon();
	void StartPingBeacon();
	void PingRegions(class TArray<class FString>& Addresses);
...
{
public:
	class TArray<struct FRegionSecret>                 Regions;                                       // 0x00E8 (0x0010) [0x0001004000400000] (CPF_NeedCtorLink)
	class TArray<struct FGetGameServerPingListData>    Servers;                                       // 0x00F8 (0x0010) [0x0001004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	class URPC_GetGameServerPingList2_X* SetRegionSecrets(class TArray<struct FRegionSecret>& InRegions);
	void eventOnSuccess();
};
...
public:
	...
	static void AssignTeams(int32_t TeamSize, class TArray<struct FReservationData>& TestPlayers);
};
...
public:
	struct FUniqueNetId                                PlayerID;                                      // 0x00E8 (0x0048) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FPlayerSkillRating>            Skills;                                        // 0x0130 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	class TArray<struct FUniqueNetId>                  PlayerIds;                                     // 0x00E8 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FPartyMemberSkill>             Players;                                       // 0x00F8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	int32_t GetPartyIndex(const struct FUniqueNetId& LeaderID, class TArray<struct FUniqueNetId>& PartyIDs);
	void InitSkillMatchPlayers(class UMatchData_X* MatchData);
	struct FSkillMatchPlayer InitSkillMatchPlayer(class UMatchData_X* MatchData, class UMatchPlayerData_X* Player, class TArray<struct FUniqueNetId>& PartyIDs);
...
{
public:
	class TArray<struct FUploadStatDataSet>            Updates;                                       // 0x00E8 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	class URPC_UpdateLeaderboard_X* SetUpdates(class TArray<struct FUploadStatDataSet>& InUpdates);
};
...
public:
	...
	class FName                                        FeatureSet;                                    // 0x0148 (0x0008) [0x0000004000000000]               
	...
	class TArray<class FName>                          CountryRestrictions;                           // 0x01F0 (0x0010) [0x0001004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	bool GetPermissionFromString(const class FName& PermissionName, EOnlinePlayerPermission& Permission);
	class TArray<EOnlinePlayerPermission> ConvertPermissions(const class TArray<class FName>& PermissionNames);
	...
	class URPC_GetPlayerPermissions_X* SetPlayers(class TArray<struct FUniqueNetId>& InPlayerIDs);
};
...
public:
	...
	static void AddPlatforms(class TArray<class UClass*>& Platforms);
...
public:
	...
	class TArray<struct FPostProcessOverride>          PostProcessOverrides;                          // 0x00C0 (0x0010) [0x0000008000400001] (CPF_Edit | CPF_NeedCtorLink)
...
public:
	...
	class URPC_CanShowAvatar_X* SetPlayerIDs(class TArray<struct FUniqueNetId>& InPlayerIDs);
};
...
{
public:
	class TArray<struct FGetGenericDataAllData>        GenericData;                                   // 0x00E8 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	struct FUniqueNetId                                PlayerID;                                      // 0x00E8 (0x0048) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<class FString>                        Titles;                                        // 0x0130 (0x0010) [0x0000004000402000] (CPF_Transient | CPF_NeedCtorLink)
...
public:
	...
	static void SplitStringInHalf(const class FString& OriginalString, class FString& FirstHalf, class FString& SecondHalf);
};
