...
public:
	...
	bool GetVariableStringArray(const class FString& Path, int32_t Index, class TArray<class FString>& Arg);
	bool GetVariableFloatArray(const class FString& Path, int32_t Index, class TArray<float>& Arg);
	bool GetVariableIntArray(const class FString& Path, int32_t Index, class TArray<int32_t>& Arg);
	bool GetVariableArray(const class FString& Path, int32_t Index, class TArray<struct FASValue>& Arg);
