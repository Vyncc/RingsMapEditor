...
public:
	...
	class TArray<struct FAkEnvironment>                LevelEnvironments;                             // 0x0068 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
	class TArray<struct FAkActorEnvironment>           ActorEnvironments;                             // 0x0078 (0x0010) [0x0000004000400000] (CPF_NeedCtorLink)
...
public:
	...
	void GetDebugData(class TArray<class FName>& RTCPKeys, class TArray<float>& RTCPValues, class TArray<class FName>& SwitchKeys, class TArray<class FName>& SwitchValues);
