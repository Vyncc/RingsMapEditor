...
{
	class FName                                        Action;                                        // 0x0000 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
	class FName                                        Key;                                           // 0x0008 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
...
{
	class FName                                        Action;                                        // 0x0000 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
	class FName                                        Category;                                      // 0x0008 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
	class FName                                        Axis;                                          // 0x0010 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
...
{
	class FName                                        Id;                                            // 0x0000 (0x0008) [0x0000000040000000] (CPF_EditInlineNotify)
