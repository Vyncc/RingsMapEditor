...
public:
	...
	void GetRegisteredPlayers(const class FName& SessionName, class TArray<struct FUniqueNetId>& OutRegisteredPlayers);
...
public:
	...
	void StoreNewAvatars(EAvatarSize Size, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate, class TArray<struct FUniqueNetId>& NewPlayerIDs);
	void ProcessOldRequests(EAvatarSize SizeType, const struct FScriptDelegate& ReadOnlineAvatarCompleteDelegate, class TArray<struct FUniqueNetId>& InPlayerIDs, class TArray<struct FUniqueNetId>& NewRequestIDs);
...
public:
	...
	void ClearAvatars();
	void Clear();
	bool TryGetImage(const class FString& Key, class UTexture*& OutValue);
	bool TryGetAvatar(struct FAvatarKey& Key, class UAvatarDownload*& OutValue);
	void GetAvatarsPendingImage(const class FString& Key, class TArray<class UAvatarDownload*>& OutAvatars);
...
public:
	...
	class UHttpRequestInterface* SetContent(class TArray<uint8_t>& ContentPayload);
	...
	void GetContent(class TArray<uint8_t>& Content);
...
public:
	...
	void RequestDecodeImage(const class FString& RequestURL, EImageType ImageType, const struct FScriptDelegate& FinishedCallback, class TArray<uint8_t>& ImageData);
...
public:
	...
	bool UploadGameplayEventsData(const struct FUniqueNetId& UniqueId, class TArray<uint8_t>& Payload);
...
public:
	...
	bool GetTitleFileContents(const class FString& Filename, class TArray<uint8_t>& FileContents);
...
public:
	...
	bool ReadTitleFile(const class FString& FileToRead, EOnlineFileType optionalFileType);
	bool UncompressTitleFileContents(EMcpFileCompressionType FileCompressionType, class TArray<uint8_t>& CompressedFileContents, class TArray<uint8_t>& UncompressedFileContents);
};
...
public:
	...
	bool CacheMessageContents(const class FString& MessageId, class TArray<uint8_t>& MessageContents);
	void CacheMessage(const struct FMcpMessage& Message);
	bool GetMessageContentsW(const class FString& MessageId, class TArray<uint8_t>& MessageContents);
	...
	void GetMessageListW(const class FString& ToUniqueUserId, struct FMcpMessageList& MessageList);
	...
	void CreateMessage(const class FString& FromUniqueUserId, const class FString& FromFriendlyName, const class FString& MessageType, const class FString& PushMessage, const class FString& ValidUntil, class TArray<class FString>& ToUniqueUserIds, class TArray<uint8_t>& MessageContents);
...
public:
	...
	bool CacheMessageContents(const class FString& MessageId, class TArray<uint8_t>& MessageContents);
	bool GetMessageByIdW(const class FString& MessageId, struct FMcpMessage& Message);
	void CacheMessage(const struct FMcpMessage& Message);
	bool GetMessageContentsW(const class FString& MessageId, class TArray<uint8_t>& MessageContents);
	...
	void CreateMessage(const class FString& FromUniqueUserId, const class FString& FromFriendlyName, const class FString& MessageType, const class FString& PushMessage, const class FString& ValidUntil, class TArray<class FString>& ToUniqueUserIds, class TArray<uint8_t>& MessageContents);
	void eventFinishedAsyncUncompression(bool bWasSuccessful, const class FString& MessageId, class TArray<uint8_t>& UncompressedMessageContents);
	bool StartAsyncUncompression(const class FString& MessageId, EMcpMessageCompressionType MessageCompressionType, class TArray<uint8_t>& MessageContent);
	bool StartAsyncCompression(EMcpMessageCompressionType MessageCompressionType, class UHttpRequestInterface* Request, class TArray<uint8_t>& MessageContent);
};
...
public:
	...
	bool WriteUserFile(const class FString& UserId, const class FString& Filename, class TArray<uint8_t>& FileContents);
	...
	void GetUserFileList(const class FString& UserId, class TArray<struct FEmsFile>& UserFiles);
	...
	bool GetFileContents(const class FString& UserId, const class FString& Filename, class TArray<uint8_t>& FileContents);
};
...
public:
	...
	bool SendHostNewGameSessionResponse(bool bSuccess, const class FName& SessionName, class UClass* SearchClass, uint8_t& PlatformSpecificInfo);
	void OnCreateNewSessionRequestReceived(const class FName& SessionName, class UClass* SearchClass, class TArray<struct FPlayerMember>& Players);
	void OnTravelRequestReceived(const class FName& SessionName, class UClass* SearchClass, uint8_t& PlatformSpecificInfo);
...
public:
	...
	void OnReceivedClientCreateNewSessionResult(bool bSucceeded, const class FName& SessionName, class UClass* SearchClass, uint8_t& PlatformSpecificInfo);
	bool RequestClientCreateNewSession(const struct FUniqueNetId& PlayerNetId, const class FName& SessionName, class UClass* SearchClass, class TArray<struct FPlayerMember>& Players);
	void TellClientsToTravel(const class FName& SessionName, class UClass* SearchClass, uint8_t& PlatformSpecificInfo);
	...
	void OnFinishedBandwidthTest(const struct FUniqueNetId& PlayerNetId, EMeshBeaconBandwidthTestType TestType, EMeshBeaconBandwidthTestResult TestResult, struct FConnectionBandwidthStats& BandwidthStats);
...
public:
	...
	bool CreateServerAuthSession(const struct FUniqueNetId& ClientUID, const struct FIpAddr& ClientIP, int32_t ClientPort, int32_t& OutAuthTicketUID);
	...
	bool CreateClientAuthSession(const struct FUniqueNetId& ServerUID, const struct FIpAddr& ServerIP, int32_t ServerPort, bool bSecure, int32_t& OutAuthTicketUID);
...
public:
	...
	bool GetActivePlatformId(uint8_t LocalUserNum, const struct FUniqueNetId& AccountId, struct FUniqueNetId& PlatformId);
...
public:
	...
	bool ReadPlatformSpecificSessionInfoBySessionName(const class FName& SessionName, uint8_t& PlatformSpecificInfo);
	...
	bool JoinMigratedOnlineGame(uint8_t PlayerNum, const class FName& SessionName, struct FOnlineGameSearchResult& DesiredGame);
	...
	bool RecalculateSkillRating(const class FName& SessionName, class TArray<struct FUniqueNetId>& Players);
	...
	bool UnregisterPlayers(const class FName& SessionName, class TArray<struct FUniqueNetId>& Players);
	...
	bool RegisterPlayers(const class FName& SessionName, class TArray<struct FUniqueNetId>& Players);
	bool RegisterPlayer(const class FName& SessionName, const struct FUniqueNetId& PlayerID, bool bWasInvited);
	bool GetResolvedConnectString(const class FName& SessionName, class FString& ConnectInfo);
	...
	bool JoinOnlineGame(uint8_t PlayerNum, const class FName& SessionName, struct FOnlineGameSearchResult& DesiredGame);
...
public:
	...
	void RequestOnlineImages(const struct FScriptDelegate& FinishedCallback, bool optionalBSupportSRGB, class TArray<class FString>& URLs);
	...
	void HandleImageDecoded_Native(const class FString& RequestedURL, struct FImageLayout& DecodedImage);
	void HandleImageDecoded(const class FString& RequestedURL, struct FImageLayout& DecodedImage);
	...
	void EventImageDecoded(const class FString& RequestURL, struct FImageLayout& Image);
...
public:
	...
	bool eventGetLobbyMembers(struct FUniqueLobbyId& LobbyId, class TArray<struct FLobbyMember>& Members);
	...
	void eventTriggerLobbyJoinGameDelegates(int32_t LobbyIndex, const class FString& ServerIP, struct FUniqueNetId& ServerId);
	...
	void eventTriggerJoinLobbyCompleteDelegates(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID);
	void OnJoinLobbyComplete(bool bWasSuccessful, const class FString& Error, struct FActiveLobbyInfo& LobbyInfo, struct FUniqueLobbyId& LobbyUID);
...
public:
	...
	void ParseDataCenterId(class TArray<uint8_t>& Data);
	...
	void ParsePlaylistPopulationData(class TArray<uint8_t>& Data);
	...
	void Reset();
	void GetContentIdsFromPlaylist(int32_t PlaylistId, class TArray<int32_t>& ContentIds);
	void GetMapCycleFromPlaylist(int32_t PlaylistId, class TArray<class FName>& MapCycle);
...
public:
	...
	bool GetAppPriceInfo(const struct FScriptDelegate& Callback, struct FUniqueNetId& PlayerID, class TArray<class FName>& AppNames);
...
public:
	...
	bool RequestReservationUpdate(const struct FUniqueNetId& RequestingPartyLeader, struct FOnlineGameSearchResult& DesiredHost, class TArray<struct FPlayerReservation>& PlayersToAdd);
	bool RequestReservation(const struct FUniqueNetId& RequestingPartyLeader, struct FOnlineGameSearchResult& DesiredHost, class TArray<struct FPlayerReservation>& Players);
...
public:
	...
	EPartyReservationResult UpdatePartyReservationEntry(const struct FUniqueNetId& PartyLeader, class TArray<struct FPlayerReservation>& PlayerMembers);
	EPartyReservationResult AddPartyReservationEntry(const struct FUniqueNetId& PartyLeader, int32_t TeamNum, bool bIsHost, class TArray<struct FPlayerReservation>& PlayerMembers);
...
public:
	...
	static class UOnlinePlaylistProvider* GetOnlinePlaylistProvider(const class FName& ProviderTag, int32_t PlaylistId, int32_t& ProviderIndex);
	bool GetPlaylistProvider(const class FName& ProviderTag, int32_t ProviderIndex, class UUIResourceDataProvider*& out_Provider);
	bool GetResourceProviders(const class FName& ProviderTag, class TArray<class UUIResourceDataProvider*>& out_Providers);
	void eventInit();
};
...
public:
	...
	void GetChallengeUserStatus(const class FString& UniqueChallengeId, const class FString& UniqueUserId, struct FMcpClashMobChallengeUserStatus& OutChallengeUserStatus);
	void QueryChallengeMultiUserStatus(const class FString& UniqueChallengeId, const class FString& UniqueUserId, class TArray<class FString>& UserIdsToRead);
	...
	void GetChallengeFileContents(const class FString& UniqueChallengeId, const class FString& DLName, class TArray<uint8_t>& OutFileContents);
	void DownloadChallengeFile(const class FString& UniqueChallengeId, const class FString& DLName);
	void GetChallengeFileList(const class FString& UniqueChallengeId, class TArray<struct FMcpClashMobChallengeFile>& OutChallengeFiles);
	...
	void GetChallengeList(class TArray<struct FMcpClashMobChallengeEvent>& OutChallengeEvents);
...
public:
	...
	void GetGroupInviteList(const class FString& UserId, struct FMcpGroupList& InviteList);
	...
	void RemoveGroupMembers(const class FString& OwnerId, const class FString& GroupId, class TArray<class FString>& MemberIds);
	void OnAddGroupMembersComplete(const class FString& GroupId, bool bWasSuccessful, const class FString& Error);
	void AddGroupMembers(const class FString& OwnerId, const class FString& GroupId, bool bRequiresAcceptance, class TArray<class FString>& MemberIds);
	void GetGroupMembers(const class FString& GroupId, class TArray<struct FMcpGroupMember>& GroupMembers);
	...
	void GetGroupList(const class FString& UserId, struct FMcpGroupList& GroupList);
...
public:
	...
	void RemoveGroupMembers(const class FString& UniqueUserId, const class FString& GroupId, class TArray<class FString>& MemberIds);
	...
	void AddGroupMembers(const class FString& UniqueUserId, const class FString& GroupId, bool bRequiresAcceptance, class TArray<class FString>& MemberIds);
	void GetGroupMembers(const class FString& GroupId, class TArray<struct FMcpGroupMember>& GroupMembers);
...
public:
	...
	void GetIdMappings(const class FString& ExternalType, class TArray<struct FMcpIdMapping>& IDMappings);
	void OnQueryMappingsComplete(const class FString& ExternalType, bool bWasSuccessful, const class FString& Error);
	void QueryMappings(const class FString& ExternalType, class TArray<class FString>& ExternalIds);
...
public:
	...
	void SellItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& InstanceItemId, int32_t Quantity, int32_t StoreVersion, class TArray<struct FMcpInventoryItemContainer>& ExpectedResultItems);
	...
	bool GetInventoryItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& InstanceItemId, struct FMcpInventoryItem& OutInventoryItem);
	void GetInventoryItems(const class FString& McpId, const class FString& SaveSlotId, class TArray<struct FMcpInventoryItem>& OutInventoryItems);
...
public:
	...
	void PurchaseItem(const class FString& McpId, const class FString& SaveSlotId, const class FString& GlobalItemId, const class TArray<class FString>& PurchaseItemIds, int32_t Quantity, int32_t StoreVersion, float Scalar);
	int32_t FindItemRequest(const class FString& McpId, const class FString& SaveSlotId, const class FString& ItemID, class TArray<struct FInventoryItemRequestState>& InItemRequests);
	int32_t FindSaveSlotRequest(const class FString& McpId, const class FString& SaveSlotId, class TArray<struct UMcpUserInventoryManager_FSaveSlotRequestState>& InSaveSlotRequests);
...
public:
	...
	bool GetUser(const class FString& McpId, struct FMcpUserStatus& User);
	void GetUsers(class TArray<struct FMcpUserStatus>& Users);
	void OnQueryUsersComplete(bool bWasSuccessful, const class FString& Error);
	void QueryUsers(class TArray<class FString>& McpIds);
